...
use YounitedPaySDK\Request\AbstractRequest as LegacyAbstractRequest;
use YounitedPaySDK\Model\AbstractModel;
use YounitedPaySDK\Request\MessageTrait;
use YounitedPaySDK\Request\RequestTrait;
use YounitedPaySDK\Stream;
use YounitedPaySDK\Uri\NewAPI\ProductionUri;
use YounitedPaySDK\Uri\NewAPI\SandboxUri;
 
/**
 * API client
*/
abstract class AbstractRequest extends LegacyAbstractRequest implements JsonSerializable
{
    ...
    public function enableSandbox()
    {
        ...
        $new->uri = $new->uri->withPath($this->requestTarget);
