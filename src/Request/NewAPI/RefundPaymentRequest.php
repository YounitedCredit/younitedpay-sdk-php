...
use YounitedPaySDK\Response\NewAPI\RefundPaymentResponse;

/**
 * Refund Payment Request Class
 */
class RefundPaymentRequest extends AbstractRequest
{
     ...
     * @var string
     */
    protected $requestTarget = '/refunds';
    ...
    /** @var string */
    protected $response = RefundPaymentResponse::class;
    ...
    {
        if ($body instanceof RefundPayment) {
            return parent::setModel($body);
        }

        throw new \InvalidArgumentException(
            'Body must be an instance of ' .  RefundPayment::class . ' but ' . get_class($body) . ' is given.'
        );
    }
}
